...
function About() {
  return (
    <div
      className="min-h-screen top-navbar w-full lg:inline-flex lg:flex-grow lg:w-auto space-x-10 shadow flex flex-row bg-violet-100 "
      id="navigation"
    >
      <h1 className="md:ml-10 text-5xl  tracking-wide font-semibold hover:text-cyan-800 px-3  py-10 justify-center ">
        About
      </h1>
      ...
      <div className=" text-center  flex p-2 rounded-md shadow md:flex md:items-center md:justify-between md:p-4 ">
        <div className="flex w-3/4 justify-center items-center space-x-32">
          <ul className="flex flex-wrap items-center mt-3 text-sm sm:mt-0">
            <li className="mx-5">
              ...
              <a
                ...
                type="button"
                className="mr-2  md:mr-5 text-3xl font-bold hover:text-cyan-800"
              >
                Maryam
              </a>
            </li>
            <li className="mx-5">
              ...
              <a
                ...
                className="mr-2  md:mr-5  data-icon= text-3xl font-bold hover:text-cyan-800"
              >
                Mhamad
              </a>
            </li>
            <li className="mx-5">
              ...
              <a
                ...
                className="mr-2 text-3xl font-bold hover:text-cyan-800"
              >
                Zeynab
              </a>
            </li>
